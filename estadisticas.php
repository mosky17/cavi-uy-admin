...
<?php } else { ?>
    ...
    <head>
        ...
        <script src="scripts1.0.12/globalize.js"></script>
        <script src="scripts1.0.12/dx.chartjs.js"></script>
        <script src="scripts1.0.12/estadisticas.js"></script>
    </head>
    ...
    <div class="container">
        ...
        <div id="torta-deuda" class="charts-containers"></div>
        <div id="torta-membresias" class="charts-containers"></div>
        ...
        <div id="torta-horas" class="charts-containers"></div>
    </div>
    </body>
