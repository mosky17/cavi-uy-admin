...
<?php } else { ?>
    ...
    <head>
        <script src="scripts1.0.12/lista_entregas.js" charset="utf-8"></script>
        <script src="scripts1.0.12/jsPDF-1.3.2/dist/jspdf.debug.js"></script>
        <script src="scripts1.0.12/jsPDF-1.3.2/plugins/standard_fonts_metrics.js"></script>
    </head>
    ...
    <div class="container">
        ...
        <div style="margin-right: 10px;" class="btn btn-primary pull-right" onclick="ListaEntregas.OpenModalGenerarRecibos();">Generar Recibos Reparto</div>
    ...
    <div id="generarRecibosModal" class="modal hide fade" tabindex="-1" role="dialog"
         aria-labelledby="generarRecibosModalLabel" aria-hidden="true">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
            <h3 id="generarRecibosModalLabel">Generar Recibos Reparto</h3>
        </div>
        <div class="modal-body">
            <div id="generarRecibosModalFeedback" class="feedbackContainerModal"></div>
            <table class="macroTabla">
                <tr>
                    <td class="fieldname">Fecha</td>
                    <td><input type="text" class="generarRecibos_fecha" placeholder="01/01/2015"></td>
                </tr>
                <tr>
                    <td class="fieldname">Variedades (Hasta 6)</td>
                    <td>
                        <div class="container_generarRecibos">
                            <table id="generarRecibos_tabla_variedades" class="table table-striped" style="width: 99%;"></table>
                        </div>
                    </td>
                </tr>
            </table>
        ...
        <div class="modal-footer">
            <img src="images/loaderModal.gif" class="loaderModal">
            <button class="btn" data-dismiss="modal" aria-hidden="true">Cerrar</button>
            <button id="generarRecibosBtnAgregar" class="btn btn-primary" onclick="ListaEntregas.GeneratePDFRecibosReparto();">Generar y Descargar</button>
        </div>
    </div>
